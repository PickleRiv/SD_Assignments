...
sshpass -f password ssh sd402@l040101-ws01.ua.pt 'cd test/MuseumHeist/dirRMIRegistry ; cp interfaces/*.class /home/sd402/Public/classes/interfaces; cp commInfra/*.class /home/sd402/Public/classes/commInfra ; cp set_rmiregistry_d.sh /home/sd402'
echo "Executing program at the RMI Registry node."
sshpass -f password ssh sd402@l040101-ws01.ua.pt './set_rmiregistry_d.sh sd402 22211'
